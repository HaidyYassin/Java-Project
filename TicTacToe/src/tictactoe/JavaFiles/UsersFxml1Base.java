...
//            return;
    ...
    private void Close() {
        ...
        Platform.runLater(() -> {
            ...
            dialogPane.getStylesheets().add(getClass().getResource("/resources/cssFiles/fullpackstyling.css").toExternalForm());
        ...
        Platform.runLater(new Runnable() {
            ...
            public void run() {
                ...
                dialogPane.getStylesheets().add(
                        getClass().getResource("/resources/cssFiles/fullpackstyling.css").toExternalForm());
                dialogPane.getStyleClass().add("infoDialog");
        ...
        Platform.runLater(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    ...
                    OnlineGame onlineGame = new OnlineGame(stage, "online", contenderName, "/resources/images/player1.png");
                    Scene scene = new Scene(onlineGame);
                    stage.setScene(scene);
                    stage.show();
